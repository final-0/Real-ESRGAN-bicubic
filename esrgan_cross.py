...
for epoch in range(0,num_epoch):
    for i, img in enumerate(dataloader):
        ...
        #--G_loss--#
            ...
            loss_gan3 = criterion_gan(fake_g, False, is_disc=False)
            Loss_G += loss_gan1
            Loss_G -= loss_gan3
            #real_g = net_D(Gan_gt)
            #loss_gan2 = criterion_gan(real_g, False, is_disc=False)
            #loss_gan4 = criterion_gan(real_g, True, is_disc=False)
            #Loss_G += loss_gan2
            #Loss_G -= loss_gan4
        ...
        #--D_loss--#
            ...
            Loss_Real = criterion_gan(real_d, False, is_disc=True)
            # fake
            fake_d = net_D(Img_out.detach().clone())  
            loss_fake = criterion_gan(fake_d, False, is_disc=True)
            Loss_Fake = criterion_gan(fake_d, True, is_disc=True)
...
#===save_model===#
torch.save(net_G.state_dict(), "saved_models3/generator.pth")
torch.save(net_D.state_dict(), "saved_models3/discriminator.pth")
